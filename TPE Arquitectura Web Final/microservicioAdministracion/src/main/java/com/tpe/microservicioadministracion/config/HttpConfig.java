package com.tpe.microservicioadministracion.config;

import com.tpe.microservicioadministracion.security.AuthorityConstants;
import com.tpe.microservicioadministracion.security.jwt.JwtFilter;
...
public class HttpConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http ) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/at/**").permitAll())
