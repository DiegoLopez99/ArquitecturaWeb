...
public class AdministradorService {
    ...
    public ResponseEntity<String> setMonopatinMantenimiento(Long idMonopatin){
        ...
        ResponseEntity<Monopatin> response = restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/id/" + idMonopatin,
                HttpMethod.GET,
                requestEntity,
        ...
        if (response.getStatusCode().is2xxSuccessful()){
            ...
            if (monopatin.getEstado().equals("disponible")){
                ...
                ResponseEntity<Monopatin> response2 = restTemplate.exchange(
                        "http://localhost:8005/mm/monopatines/" + idMonopatin,
                        HttpMethod.PUT,
                        requestEntity2,
                        responseType
                );
    ...
    public ResponseEntity<String> setMonopatinFinMantenimiento(Long idMonopatin, Long idMantenimiento) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization","Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzYWl0YW1hQHlhaG9vLmNvbSIsImF1dGgiOiJBRE1JTixVU0VSIiwiZXhwIjoxNzAwMjg4MjgwfQ.xduOpTirzKprMO3AKbWkDAZtpThfTZ-7_a-7xF5WO3n24Hs7xtU6PdZHM1SYE4iSobW536vO-qCQAskivOudbQ");
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        ResponseEntity<Monopatin> response = restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/id/" + idMonopatin,
                HttpMethod.GET,
    ...
    private void agregarMantenimiento(Long idMonopatin) {
        ...
        restTemplate.exchange(
                "http://localhost:8005/mm/mantenimientos/guardar",
                HttpMethod.POST,
                requestEntity,
                String.class
        );
    ...
    private void finalizarMantenimiento(Long idMantenimiento) {
        ...
        ResponseEntity<Mantenimiento> response = restTemplate.exchange(
                "http://localhost:8005/mm/mantenimientos/id/" + idMantenimiento,
                HttpMethod.GET,
                requestEntity,
        ...
        if (response.getStatusCode().is2xxSuccessful()){
            ...
            restTemplate.exchange(
                    "http://localhost:8005/mm/mantenimientos/" + idMantenimiento,
                    HttpMethod.PUT,
                    requestEntity2,
                    responseType
            );
    ...
    public ResponseEntity<Object> agregarMonopatin(Monopatin monopatin) {
        ...
        ParameterizedTypeReference<Monopatin> responseType = new ParameterizedTypeReference<Monopatin>() {};
        ResponseEntity<Monopatin> response = restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/guardar",
                HttpMethod.POST,
                requestEntity,
                responseType
        );
    ...
    public ResponseEntity<Object> agregarParada(Parada parada) {
        ...
        ResponseEntity<Parada> response = restTemplate.exchange(
                "http://localhost:8004/p/paradas/agregar",
                HttpMethod.POST,
                requestEntity,
                responseType
        );
    ...
    public ResponseEntity<Object> eliminarParada(Long idParada) {
        ...
        ParameterizedTypeReference<Parada> responseType = new ParameterizedTypeReference<Parada>() {};
        ResponseEntity<Parada> response = restTemplate.exchange(
                "http://localhost:8004/p/paradas/" + idParada,
                HttpMethod.DELETE,
                requestEntity,
                responseType
        );
    ...
    public ResponseEntity<String> anularCuenta(Long idCuenta) {
        ...
        ResponseEntity<Cuenta> response = restTemplate.exchange(
                "http://localhost:8001/uc/cuentas/id/" + idCuenta,
                HttpMethod.GET,
                requestEntity,
        ...
        if (response.getStatusCode().is2xxSuccessful()){
            ...
            if (cuenta.getEstado().equals("activa")){
                ...
                ResponseEntity<Cuenta> response2 = restTemplate.exchange(
                        "http://localhost:8001/uc/cuentas/" + idCuenta,
                        HttpMethod.PUT,
                        requestEntity2,
                        responseType
                );
    ...
    public ResponseEntity<Object> generarReporteMonopatinesKm(Float kmMinimo, Float kmMaximo) {
        ...
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/reporte/kmMinimo/"+ kmMinimo+ "/kmMaximo/"+kmMaximo,
                HttpMethod.GET,
                requestEntity,
    ...
    public ResponseEntity<Object> generarReporteMonopatinesTiempoUsoConPausa() {
        ...
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/reporte/porTiempoConPausa",
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
    ...
    public ResponseEntity<Object> generarReporteMonopatinesTiempoUso() {
        ...
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/reporte/porTiempo",
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
    ...
    public ResponseEntity<Object> obtenerMonopatinesConMasViajesEnAnio(Integer cant, Integer anio) {
        ...
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/cantViajes/"+cant+"/anio/"+anio,
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
    ...
    public ResponseEntity<Object> obtenerTotalFacturado(String mesInicio, String mesFinal, Integer anio) {
        ...
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        return restTemplate.exchange(
                "http://localhost:8006/vp/viajes/totalFacturado/mesInicio/"+mesInicio+"mesFinal/"+mesFinal+"anio/"+anio,
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
    ...
    public ResponseEntity<Object> obtenerMonopatinesOperacionYmantenimiento() {
        ...
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/enOperacionYMantenimiento",
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
    ...
    @Transactional
    public ResponseEntity<Object> getMonopatinesPorUbicacion(String ubi) {
        HttpHeaders headers = new HttpHeaders();
        HttpEntity<Void> requestEntity = new HttpEntity<>(headers);
        return restTemplate.exchange(
                "http://localhost:8005/mm/monopatines/monopatinesPorUbicacion/ubicacion/"+ubi,
                HttpMethod.GET,
                requestEntity,
                new ParameterizedTypeReference<>() {}
        );
